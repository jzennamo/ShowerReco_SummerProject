...
// Mon Jun 29 10:52:48 2015 by ROOT version 5.34/22
// from TTree anatree/analysis tree
// found on file: prod_bnblike_eminus_standard_reco_hist.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Double_t        taulife;
   Int_t           no_hits;
   Short_t         hit_plane[2144];   //[no_hits]
   Short_t         hit_wire[2144];   //[no_hits]
   Short_t         hit_channel[2144];   //[no_hits]
   Float_t         hit_peakT[2144];   //[no_hits]
   Float_t         hit_charge[2144];   //[no_hits]
   Float_t         hit_ph[2144];   //[no_hits]
   Float_t         hit_startT[2144];   //[no_hits]
   Float_t         hit_endT[2144];   //[no_hits]
   Float_t         hit_trueX[2144];   //[no_hits]
   Float_t         hit_goodnessOfFit[2144];   //[no_hits]
   Short_t         hit_multiplicity[2144];   //[no_hits]
   Short_t         hit_trkid[2144];   //[no_hits]
   Float_t         hit_nelec[2144];   //[no_hits]
   Float_t         hit_energy[2144];   //[no_hits]
   Short_t         nvtx;
   Float_t         vtx[1][3];   //[nvtx]
   Int_t           no_flashes;
   Float_t         flash_time[70];   //[no_flashes]
   Float_t         flash_pe[70];   //[no_flashes]
   Float_t         flash_ycenter[70];   //[no_flashes]
   Float_t         flash_zcenter[70];   //[no_flashes]
   Short_t         nshowers;
   ...
   Int_t           pdg[152];   //[geant_list_size]
   Int_t           status[152];   //[geant_list_size]
   Float_t         Mass[152];   //[geant_list_size]
   Float_t         Eng[152];   //[geant_list_size]
   Float_t         EndE[152];   //[geant_list_size]
   Float_t         Px[152];   //[geant_list_size]
   Float_t         Py[152];   //[geant_list_size]
   Float_t         Pz[152];   //[geant_list_size]
   Float_t         P[152];   //[geant_list_size]
   Float_t         StartPointx[152];   //[geant_list_size]
   Float_t         StartPointy[152];   //[geant_list_size]
   Float_t         StartPointz[152];   //[geant_list_size]
   Float_t         StartT[152];   //[geant_list_size]
   Float_t         EndPointx[152];   //[geant_list_size]
   Float_t         EndPointy[152];   //[geant_list_size]
   Float_t         EndPointz[152];   //[geant_list_size]
   Float_t         EndT[152];   //[geant_list_size]
   Float_t         theta[152];   //[geant_list_size]
   Float_t         phi[152];   //[geant_list_size]
   Float_t         theta_xz[152];   //[geant_list_size]
   Float_t         theta_yz[152];   //[geant_list_size]
   Float_t         pathlen[152];   //[geant_list_size]
   Int_t           inTPCActive[152];   //[geant_list_size]
   Float_t         StartPointx_tpcAV[152];   //[geant_list_size]
   Float_t         StartPointy_tpcAV[152];   //[geant_list_size]
   Float_t         StartPointz_tpcAV[152];   //[geant_list_size]
   Float_t         EndPointx_tpcAV[152];   //[geant_list_size]
   Float_t         EndPointy_tpcAV[152];   //[geant_list_size]
   Float_t         EndPointz_tpcAV[152];   //[geant_list_size]
   Int_t           NumberDaughters[152];   //[geant_list_size]
   Int_t           Mother[152];   //[geant_list_size]
   Int_t           TrackId[152];   //[geant_list_size]
   Int_t           MergedId[152];   //[geant_list_size]
   Int_t           origin[152];   //[geant_list_size]
   Int_t           MCTruthIndex[152];   //[geant_list_size]
   Int_t           process_primary[152];   //[geant_list_size]
   vector<string>  *processname;
   Short_t         ntracks_trackkalmanhit;
   Short_t         trkId_trackkalmanhit[13];   //[ntracks_trackkalmanhit]
   Short_t         trkncosmictags_tagger_trackkalmanhit[13];   //[ntracks_trackkalmanhit]
   Float_t         trkcosmicscore_tagger_trackkalmanhit[13];   //[ntracks_trackkalmanhit]
   Short_t         trkcosmictype_tagger_trackkalmanhit[13];   //[ntracks_trackkalmanhit]
   Short_t         trkncosmictags_flashmatch_trackkalmanhit[13];   //[ntracks_trackkalmanhit]
   Float_t         trkcosmicscore_flashmatch_trackkalmanhit[13];   //[ntracks_trackkalmanhit]
   Short_t         trkcosmictype_flashmatch_trackkalmanhit[13];   //[ntracks_trackkalmanhit]
   Float_t         trkke_trackkalmanhit[13][3];   //[ntracks_trackkalmanhit]
   Float_t         trkrange_trackkalmanhit[13][3];   //[ntracks_trackkalmanhit]
   Int_t           trkidtruth_trackkalmanhit[13][3];   //[ntracks_trackkalmanhit]
   Short_t         trkorigin_trackkalmanhit[13][3];   //[ntracks_trackkalmanhit]
   Int_t           trkpdgtruth_trackkalmanhit[13][3];   //[ntracks_trackkalmanhit]
   Float_t         trkefftruth_trackkalmanhit[13][3];   //[ntracks_trackkalmanhit]
   Float_t         trkpurtruth_trackkalmanhit[13][3];   //[ntracks_trackkalmanhit]
   Float_t         trkpitchc_trackkalmanhit[13][3];   //[ntracks_trackkalmanhit]
   Short_t         ntrkhits_trackkalmanhit[13][3];   //[ntracks_trackkalmanhit]
   Float_t         trkdedx_trackkalmanhit[13][3][2000];   //[ntracks_trackkalmanhit]
   Float_t         trkdqdx_trackkalmanhit[13][3][2000];   //[ntracks_trackkalmanhit]
   Float_t         trkresrg_trackkalmanhit[13][3][2000];   //[ntracks_trackkalmanhit]
   Float_t         trkxyz_trackkalmanhit[13][3][2000][3];   //[ntracks_trackkalmanhit]
   Float_t         trkstartx_trackkalmanhit[13];   //[ntracks_trackkalmanhit]
   Float_t         trkstarty_trackkalmanhit[13];   //[ntracks_trackkalmanhit]
   Float_t         trkstartz_trackkalmanhit[13];   //[ntracks_trackkalmanhit]
   Float_t         trkstartd_trackkalmanhit[13];   //[ntracks_trackkalmanhit]
   Float_t         trkendx_trackkalmanhit[13];   //[ntracks_trackkalmanhit]
   Float_t         trkendy_trackkalmanhit[13];   //[ntracks_trackkalmanhit]
   Float_t         trkendz_trackkalmanhit[13];   //[ntracks_trackkalmanhit]
   Float_t         trkendd_trackkalmanhit[13];   //[ntracks_trackkalmanhit]
   Float_t         trktheta_trackkalmanhit[13];   //[ntracks_trackkalmanhit]
   Float_t         trkphi_trackkalmanhit[13];   //[ntracks_trackkalmanhit]
   Float_t         trkstartdcosx_trackkalmanhit[13];   //[ntracks_trackkalmanhit]
   Float_t         trkstartdcosy_trackkalmanhit[13];   //[ntracks_trackkalmanhit]
   Float_t         trkstartdcosz_trackkalmanhit[13];   //[ntracks_trackkalmanhit]
   Float_t         trkenddcosx_trackkalmanhit[13];   //[ntracks_trackkalmanhit]
   Float_t         trkenddcosy_trackkalmanhit[13];   //[ntracks_trackkalmanhit]
   Float_t         trkenddcosz_trackkalmanhit[13];   //[ntracks_trackkalmanhit]
   Float_t         trkthetaxz_trackkalmanhit[13];   //[ntracks_trackkalmanhit]
   Float_t         trkthetayz_trackkalmanhit[13];   //[ntracks_trackkalmanhit]
   Float_t         trkmom_trackkalmanhit[13];   //[ntracks_trackkalmanhit]
   Float_t         trkmomrange_trackkalmanhit[13];   //[ntracks_trackkalmanhit]
   Float_t         trkmommschi2_trackkalmanhit[13];   //[ntracks_trackkalmanhit]
   Float_t         trkmommsllhd_trackkalmanhit[13];   //[ntracks_trackkalmanhit]
   Float_t         trklen_trackkalmanhit[13];   //[ntracks_trackkalmanhit]
   Short_t         trksvtxid_trackkalmanhit[13];   //[ntracks_trackkalmanhit]
   Short_t         trkevtxid_trackkalmanhit[13];   //[ntracks_trackkalmanhit]
   Int_t           trkpidpdg_trackkalmanhit[13][3];   //[ntracks_trackkalmanhit]
   Float_t         trkpidchi_trackkalmanhit[13][3];   //[ntracks_trackkalmanhit]
   Float_t         trkpidchipr_trackkalmanhit[13][3];   //[ntracks_trackkalmanhit]
   Float_t         trkpidchika_trackkalmanhit[13][3];   //[ntracks_trackkalmanhit]
   Float_t         trkpidchipi_trackkalmanhit[13][3];   //[ntracks_trackkalmanhit]
   Float_t         trkpidchimu_trackkalmanhit[13][3];   //[ntracks_trackkalmanhit]
   Float_t         trkpidpida_trackkalmanhit[13][3];   //[ntracks_trackkalmanhit]
   Short_t         trkpidbestplane_trackkalmanhit[13];   //[ntracks_trackkalmanhit]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("prod_bnblike_eminus_standard_reco_hist.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("prod_bnblike_eminus_standard_reco_hist.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("prod_bnblike_eminus_standard_reco_hist.root:/analysistree");
